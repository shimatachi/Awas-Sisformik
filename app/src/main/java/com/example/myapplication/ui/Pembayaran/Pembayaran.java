 ...
 * Use the {@link Pembayaran#newInstance} factory method to
...
public class Pembayaran extends Fragment {
    ...
    public static Pembayaran newInstance(String param1, String param2) {
        Pembayaran fragment = new Pembayaran();
